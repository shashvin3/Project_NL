      ...
      <div className="grid gap-12 lg:grid-cols-4 mb-7">
        ...
        <div className="space-y-6"> 
          ...
          <div className="flex gap-7 pt-4">
            ...
            <a href="#" className="border rounded-xl p-2 border-gray-300 hover:opacity-80 transition-opacity">
            ...
            <a href="https://www.linkedin.com/company/navlakshya" target="_blank" rel="noopener noreferrer" className="border rounded-xl p-2 border-gray-300 hover:opacity-80 transition-opacity">
