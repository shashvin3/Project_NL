...
function Banner({title, des, firstBtnText, secondBtnText, bgColor, titleTextColor, desTextColor,firBtnTextColor, secBtnTextColor, firBtnBg, secBtnBg, secBtnBorder, firstIcon, secondIcon,firstBtnLink,secondBtnLink}) {
  return (
