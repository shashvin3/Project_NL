       ...
       <div className="flex gap-10 items-start">
          ...
          <p className=" text-grayone  leading-relaxed mb-1">
           ...
           <ul className="mb-3">
            ...
            "Historical public domain information"].map((item) => (
              <li className="flex items-startr gap-2">
                <img src={bluedot} alt="" className="w-2 h-2 mt-2" />
        ...
        <div className="hidden lg:block w-64 shrink-0">
         <div className="sticky top-24 bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
          ...
          {["Use of Information","Validity of Information","Accuracy of Information"," Source of Information","Non-Affiliation","Partnership with Scholarship Providers","Limitation of Liability","Consent"].map((items) =>(
